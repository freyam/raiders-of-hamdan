...
class Queen(Troop):
    ...
    def attackSpecial(self, game):
        ...
        #         print(game.kingdom.kingdom[y][x], end="")
        #     print()
...
class Archer(Troop):
    ...
    def moveToNearestHostileStructure(self, game):
        ...
        # set self.inposition = True if archer within 3 units of the nearest structure
        if (
            abs(self.x - nearest_structure.x) <= 3
            and abs(self.y - nearest_structure.y) <= 3
        ):
